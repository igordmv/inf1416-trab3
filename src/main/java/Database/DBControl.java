...
public class DBControl {
    ...
    public void clearRegisters() {
        ...
        runQueryInsertUpdate(String.format("DELETE FROM Registro"));
    ...
    /* **************************************************************************************************
     **
     **  MARK: Increase Consult Access
     **
     ****************************************************************************************************/

    public void increaseConsultAccess() {

        runQueryInsertUpdate(String.format("UPDATE User SET countConsult = countConsult + 1 WHERE email = '%s'", LoggedUser.getInstance().getEmail()));
